      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white border rounded-lg p-6 shadow-md">
          ...
          <div className="flex items-center">
            <img className="w-12 h-12 rounded-full" src="img/testimonial-1.jpg" alt="Nacharaju Raghavendra Rao" />
            <div className="ml-3">
        ...
        <div className="bg-white border rounded-lg p-6 shadow-md">
          ...
          <div className="flex items-center">
            <img className="w-12 h-12 rounded-full" src="img/testimonial-2.jpg" alt="Sri Vijayalakshmi" />
            <div className="ml-3">
        ...
        <div className="bg-white border rounded-lg p-6 shadow-md">
          ...
          <div className="flex items-center">
            <img className="w-12 h-12 rounded-full" src="img/testimonial-3.jpg" alt="Laxman Reguri" />
            <div className="ml-3">
        ...
        <div className="bg-white border rounded-lg p-6 shadow-md">
          ...
          <div className="flex items-center">
            <img className="w-12 h-12 rounded-full" src="img/testimonial-4.jpg" alt="Srinivas" />
            <div className="ml-3">
